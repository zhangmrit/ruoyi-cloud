...
public class SysOssController extends BaseController
{
    ...
    public TableDataInfo list(SysOss sysOss)
    {
        ...
        List<SysOss> list = sysOssService.selectSysOssList(sysOss, page);
    ...
    public AjaxResult upload(@RequestParam("file") MultipartFile file) throws Exception
    {
        ...
        return toAjax(sysOssService.insertSysOss(ossEntity)).put("url", ossEntity.getUrl()).put("fileName",ossEntity.getFileName());
    }
    ...
    {
        SysOss sysOss = sysOssService.selectSysOssById(ossId);
